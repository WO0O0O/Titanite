...
const MOCK_COMPANY_DETAILS: Record<string, { name: string; price: number; marketCap: number; currency: string }> = {
  ...
  LPK:    { name: 'LPKF Laser & Electronics',  price: 16.00,         marketCap: 380_000_000,       currency: 'EUR' },
  LPKF:   { name: 'LPKF Laser & Electronics',  price: 16.00,         marketCap: 380_000_000,       currency: 'EUR' },
